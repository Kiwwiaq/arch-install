...
sudo pacman --noconfirm --needed -S mesa xf86-video-amdgpu vulkan-radeon libva-mesa-driver mesa-vdpau xorg-server lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings cinnamon
...
sudo pacman --noconfirm --needed -S lollypop totem goobox gst-libav gst-plugins-ugly
